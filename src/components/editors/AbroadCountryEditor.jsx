...
export default function AbroadCountryEditor({ data = [], onChange }) {
  const addCountry = () => {
    onChange([
      ...(data || []),
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                value={item.country || ""}
                onChange={(e) =>
                  updateItem(index, "country", e.target.value)
                }
              >
            ...
            <div>
              ...
              <input
                ...
                value={item.start || ""}
                onChange={(e) =>
                  updateItem(index, "start", e.target.value)
                }
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={item.end || ""}
                onChange={(e) =>
                  updateItem(index, "end", e.target.value)
                }
              />
            </div>
          </div>
